...
<body class="antialiased">
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box;">
        ...
        <div class="empty-2-2 container mx-auto d-flex align-items-center justify-content-center flex-column">
            <div class="wrapper w-100">
                ...
                <div class="row mt-4">
                    <table class="table align-middle mb-0 bg-white" id="pendudukProvinceTable">
                        ...
                        <tbody>
                            @forelse ($data as $row)
                                <tr>
                                    <td>
                                        <p class="fw-normal">{{ $loop->iteration }}</p>
                                    </td>
                                    <td>
                                        <p class="fw-normal">{{ $row['province'] }}</p>
                                    </td>
                                    <td>
                                        <p class="fw-normal">{{ $row['total'] }}</p>
                                    </td>
                                </tr>
                            @empty
                                <tr>
    ...
    <script>
        $(document).ready(function() {
            $('#pendudukProvinceTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    'csv', 'excel', 'print'
                ],
